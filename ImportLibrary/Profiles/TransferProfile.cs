    ...
    public class TransferProfile : Profile
    {
        protected override void Configure()
        {
            CreateMap<Observer.FishTransfer, Tubs.Transfer>()
                ...
                // Handled in AfterMap
                .ForMember(d => d.TransferDateOnly, o => o.Ignore())
                .ForMember(d => d.TransferTimeOnly, o => o.Ignore())
                // Member properties
                ...
                .ForMember(d => d.TransferDate, o => o.MapFrom(s => s.GetDate()))
                ...
                .AfterMap((s, d) =>
                {
                    d.TransferDateOnly = d.TransferDate.AtMidnight();
                    d.TransferTimeOnly = d.TransferDate.TimeOnly();
                })
            ;
        }
    }
